...
export const metadata: Metadata = { title: 'Posts — Bananagram', icons: { icon: '/LogoMonkey.png' } };
  ...
  return (
    <html lang="es" className={poppins.variable}>
      {/* suppressHydrationWarning: algunas extensiones del navegador (ej.
          ...
          sus hijos. */}
      <body style={{ margin: 0, backgroundColor: '#F7F7F7', fontFamily: 'var(--font-poppins), Arial, sans-serif' }} suppressHydrationWarning>
