...
const NAV_ITEMS_WITH_PERMISSION: NavItemWithPermission[] = [
  ...
  { key: 'posts', label: 'Posts', href: '/posts', icon: <ArticleIcon />, requirePermission: { module: 'post', action: 'create' } },
...
export function Sidebar() {
  ...
  function handleNavigate(href: string) {
    // Dashboard/Campañas/Métricas/Team viven en web-shell; Posts se queda
    // dentro de este microfront, así que navegamos local solo en ese caso.
