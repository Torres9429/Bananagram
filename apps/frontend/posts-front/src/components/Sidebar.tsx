...
const NAV_ITEMS_WITH_PERMISSION: NavItemWithPermission[] = [
  ...
  { key: 'posts', label: 'Posts', href: '/posts', icon: <ArticleIcon />, requirePermission: [{ module: AppModule.POST, action: AppAction.CREATE }, { module: AppModule.POST, action: AppAction.APPROVE }] },
