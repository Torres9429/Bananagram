...
const NAV_ITEMS_WITH_PERMISSION: NavItemWithPermission[] = [
  ...
  { key: 'approvals', label: 'Aprobaciones', href: `${POSTS_FRONT_URL}/posts/approvals`, icon: <RateReviewOutlinedIcon />, requirePermission: { module: 'post', action: 'approve' } },
...
export function Sidebar() {
  ...
  function handleNavigate(href: string) {
    // Solo Dashboard vive en web-shell; el resto son otros microfronts,
    // cada uno en su propio puerto (origen distinto) — el email viaja en
    // la URL para que la zona destino reconstruya su propia sesión.
